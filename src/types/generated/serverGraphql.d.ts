...
import { CustomContext } from '../server/context';
...
export type AuthorizationDirectiveArgs = {   requires?: Maybe<UserRole>; };

export type AuthorizationDirectiveResolver<Result, Parent, ContextType = CustomContext, Args = AuthorizationDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type MutationResolvers<ContextType = CustomContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  saveUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationSaveUserArgs, never>>;
}>;
 ...
 */
export type IDirectiveResolvers<ContextType = CustomContext> = DirectiveResolvers<ContextType>;